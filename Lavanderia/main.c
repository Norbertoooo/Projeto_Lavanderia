    ...
    do{
        ...
        switch(escolha){
            ...
            case 1:
                ...
                printf("Quantidade de Passadeira de chão/mesa Pequena: ");
                scanf("%lf",&C.passadeiraPeq);
                C.valor += C.passadeiraPeq * 15;
                fprintf(p,"Passadeira de chão/mesa peq --------------- %.2lf UNI\n",C.passadeiraPeq);
                fflush(stdin);

                printf("Quantidade de Passadeira de chão/mesa Grande: ");
                ...
                printf("Quantidade de Camisas Socias de Mangas Longas: ");
                scanf("%lf",&C.camisaSocialML);
                fprintf(p,"Camisas Socias de Mangas Longas: ---------- %.2lf UNI\n",C.camisaSocialML);
                C.valor += C.camisaSocialML * 10;
                fflush(stdin);

                printf("Quantidade de Camisas Socias de Mangas Curtas: ");
